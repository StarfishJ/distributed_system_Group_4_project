...
public class HealthController {
    ...
    public HealthController(ServerMetrics metrics) {
    ...
    public Mono<Map<String, Object>> health() {
        ...
        response.put("activeSessions", metrics.getActiveSessions());
        response.put("messagesReceived", metrics.getMessagesReceived());
